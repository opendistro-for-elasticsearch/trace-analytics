...
/******/ 	var installedChunks = {
/******/ 		"opendistro-trace-analytics-kibana": 0
/******/ 	};
/******/
/******/
/******/
...
/******/
/******/ 	var jsonpArray = window["opendistro-trace-analytics-kibana_bundle_jsonpfunction"] = window["opendistro-trace-analytics-kibana_bundle_jsonpfunction"] || [];
...
__webpack_require__.p = window.__kbnPublicPath__['opendistro-trace-analytics-kibana']
...
/* harmony import */ var _node_modules_val_loader_dist_cjs_js_key_opendistro_trace_analytics_kibana_kbn_ui_shared_deps_public_path_module_creator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../node_modules/val-loader/dist/cjs.js?key=opendistro-trace-analytics-kibana!../../../kbn-ui-shared-deps/public_path_module_creator.js */ "../../node_modules/val-loader/dist/cjs.js?key=opendistro-trace-analytics-kibana!../../packages/kbn-ui-shared-deps/public_path_module_creator.js");
/* harmony import */ var _node_modules_val_loader_dist_cjs_js_key_opendistro_trace_analytics_kibana_kbn_ui_shared_deps_public_path_module_creator_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_val_loader_dist_cjs_js_key_opendistro_trace_analytics_kibana_kbn_ui_shared_deps_public_path_module_creator_js__WEBPACK_IMPORTED_MODULE_0__);
__kbnBundles__.define('plugin/opendistro-trace-analytics-kibana/public', __webpack_require__, /*require.resolve*/(/*! ../../../../plugins/trace-analytics/public */ "./public/index.ts"))
...
switch (window.__kbnThemeTag__) {
  ...
  case 'v8dark':
    console.error(new Error("SASS files in [opendistro-trace-analytics-kibana] were not built for theme [v8dark]. Styles were compiled using the [v7dark] theme instead to keep Kibana somewhat usable. Please adjust the advanced settings to make use of [v7dark,v7light] or make sure the KBN_OPTIMIZER_THEMES environment variable includes [v8dark] in a comma separated list of themes you want to compile. You can also set it to \"*\" to build all themes."));
    return __webpack_require__(/*! ./index.scss?v7dark */ "./public/index.scss?v7dark")

  case 'v8light':
    console.error(new Error("SASS files in [opendistro-trace-analytics-kibana] were not built for theme [v8light]. Styles were compiled using the [v7light] theme instead to keep Kibana somewhat usable. Please adjust the advanced settings to make use of [v7dark,v7light] or make sure the KBN_OPTIMIZER_THEMES environment variable includes [v8light] in a comma separated list of themes you want to compile. You can also set it to \"*\" to build all themes."));
    return __webpack_require__(/*! ./index.scss?v7light */ "./public/index.scss?v7light")
}
...
/******/ });
//# sourceMappingURL=opendistro-trace-analytics-kibana.plugin.js.map